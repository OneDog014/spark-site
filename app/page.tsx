  ...
  const posts: Post[] = [
    {
      ...
      title: "なぜIT運用は何年経っても変わらないのか",
      date: "2026.03.30",
      excerpt:
        "同じ作業、同じ疲弊、同じ属人化。変えようとしているのに変わらない背景には、個人の問題ではなく構造の問題があります。",
      content: [
        "IT運用の現場では、改善という言葉が日常的に使われています。ツールを入れ、手順を増やし、会議を重ね、インシデントが起きるたびに対策を積み上げる。それでも数年後に振り返ると、現場の疲れ方はほとんど変わっていないことがあります。",
        "なぜ変わらないのか。私は、その理由は努力不足ではなく構造にあると思っています。責任分界が曖昧なまま、現場が最後に吸収する。人が抜けると回らない前提のまま、個人の経験に依存する。変えることより止めないことが優先される。そうした前提の積み重なりが、運用を固定化していきます。",
    ...
    },
    {
      ...
      title: "運用の民主化とは、専門家を不要にすることではない",
      date: "2026.03.24",
      excerpt:
      ...
      content: [
        ...
        "運用の民主化も同じです。それは、専門家を否定する話ではありません。むしろ逆で、専門家の知見を個人に閉じ込めたままにしないための考え方です。特定の人しかできない状態を、少しずつ構造に埋め込む。判断基準を明文化し、再現性を持たせ、誰が触っても最低限安全に動けるようにする。",
        "紙詰まりは誰でも直せる。でも光学系やフィーダーの修理は専門家が必要です。運用も同じです。民主化されるのは操作や入り口であり、設計や深い専門性はむしろ価値が増していく。その境界をどう設計するかが、本当の論点だと思っています。",
      ],
    },
  ];
